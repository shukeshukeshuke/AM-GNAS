...
def extract_multi_hop_neighbors(g, K, max_edge_attr_num, max_hop_num,
    ...
    # g.edata['feat'] = torch.ones(g.num_edges()).long()

    g.edata['feat'] = torch.tensor([i[0] + 0.5 * i[1]  for i in edge_attr]).long()
