...
from models.operations import OPS, First_Stage, Second_Stage, Third_Stage, K_Message
...
class Model_Search(nn.Module):
    ...
    def __init__(self, args, trans_input_fn, loss_fn):
        ...
        self.trans_input = TransInput(args, trans_input_fn)
    ...
    def load_cell_arch_by_layer(self):
        ...
        for dst in range(1, self.args.nb_nodes + 1):
            for src in range(dst):
                arch_topo.append((src, dst, w, K_Message))
                w += 1
