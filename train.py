...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        self.console.log(f'==> [3.2] Adding hop neighbors')
        self.dataset._add_hop_neighbors(args.K, args.max_pe_num, args.max_hop_num, args.max_edge_type,
                                        args.max_edge_count, args.max_distance_count, args.kernel)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--fn_agg", type=str, default="mean", choices=("mean", "sum", "max", "min"))
    ...
    parser.add_argument("--max_edge_count", type=int, default=20000,
